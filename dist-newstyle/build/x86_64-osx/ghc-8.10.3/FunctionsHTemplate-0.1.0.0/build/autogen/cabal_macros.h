...
/* package FunctionsHTemplate-0.1.0.0 */
#ifndef VERSION_FunctionsHTemplate
#define VERSION_FunctionsHTemplate "0.1.0.0"
#endif /* VERSION_FunctionsHTemplate */
#ifndef MIN_VERSION_FunctionsHTemplate
#define MIN_VERSION_FunctionsHTemplate(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_FunctionsHTemplate */
...
#define CURRENT_PACKAGE_KEY "FunctionsHTemplate-0.1.0.0-inplace"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "FunctionsHTemplate-0.1.0.0-inplace"
